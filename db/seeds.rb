...
Account.create(first_name: 'Jorge', last_name: 'Navarro', email: 'jnavarr56@gmail.com', password: 'password', dob: Date.new(1995,2,19), last_accessed: 'n/a', time_logged: 'n/a', verify_code: 'n/a', verified: true)
